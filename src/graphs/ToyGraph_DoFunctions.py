    ...
    for variable, value in interventions[0].items():
        ...
        if num_children != 0:
            for i in range(num_children):
                ...
                # If this function gets other variables that are not children of the intervention we need to add them
                # here. This is changing the X_2 - taking the mean value of GP2
        ...
        # The independent nodes stay the same - If don't exist don't need to provide
        ...
        # The parents nodes stay the same - If don't exist don't need to provide
        if num_parents != 0:
